        ...
        if !isValidJSON {
            ...
            if let httpBody = httpBodyData {
                if let stringData = String(data: httpBody, encoding: .utf8) {
                    requestObject["Requestbody"] = stringData
                }
            }
        }
