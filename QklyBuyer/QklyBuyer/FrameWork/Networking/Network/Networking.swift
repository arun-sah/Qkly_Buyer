...
final public class Networking {
    ...
    public func requestObject<O>(type: O.Type?, router: NetworkingRouter,isuploadFile:Bool = false, uploadDocumentFrom:UploadDocumentFrom = .general,parametersdata: [String: Data?]? = nil, params: [String: Any]? = nil ,completion: @escaping (_ result: NetworkingResult<O>) -> Void) {
        //create the operation
        let queueable = RequestSynchronizer<O>(client: configuration.client, router: router, tokenManager: configuration.tokenManager, isuploadFile: isuploadFile, uploadDocumentFrom: uploadDocumentFrom,parametersdata: parametersdata,params: params)
