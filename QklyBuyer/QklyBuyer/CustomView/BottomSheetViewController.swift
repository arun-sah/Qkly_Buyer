...
protocol BottomSheetViewControllerDelegate: AnyObject {
    func viewDidLoad(forView customView: UIView)
}

class BottomSheetViewController: UIViewController {
    
    init(withView customView: UIView & BottomSheetViewControllerDelegate, height: CGFloat = 230, dismissHeight: CGFloat = 150) {
        self.defaultHeight = height
        self.dismissibleHeight = dismissHeight
        self.currentContainerHeight = height
        self.maximumContainerHeight = height
        self.currentContainerHeight = customView.bounds.height
    ...
    private let maximumContainerHeight: CGFloat
    ...
    override func viewDidLoad() {
        ...
        delegate?.viewDidLoad(forView: customView)
    }
    ...
    func load(on vc: UIViewController) {
